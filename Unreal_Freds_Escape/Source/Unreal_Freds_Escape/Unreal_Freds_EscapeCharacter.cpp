...
{	
	...
	{
		// Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &AUnreal_Freds_EscapeCharacter::DoJumpStart);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &AUnreal_Freds_EscapeCharacter::DoJumpEnd);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUnreal_Freds_EscapeCharacter::MoveInput);
	...
	{
		UE_LOG(LogUnreal_Freds_Escape, Error, TEXT("'%s' Failed to find an Enhanced Input Component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}


void AUnreal_Freds_EscapeCharacter::MoveInput(const FInputActionValue& Value)
{
...
void AUnreal_Freds_EscapeCharacter::LookInput(const FInputActionValue& Value)
{
...
void AUnreal_Freds_EscapeCharacter::DoJumpEnd()
{
